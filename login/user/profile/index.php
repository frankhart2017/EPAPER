                    ...
                    <br>
                     <div class="input-field col s12 m6">
                      ...
                      <div class="row col s12 m12 center">
                        <a href="../resetquestions/" class="left col s12 m4 btnsize waves-effect waves-light btn <?php echo $color; ?>">RESET SECURITY QUESTIONS</a>
                        <a class="right col s12 m4 btnsize waves-effect waves-light btn <?php echo $color; ?>" id="btn1">UPDATE</a>
                      </div>

              </div>

              <div class="row" style="margin-left: 0px;">
                <a class="left col s12 m4 btnsize waves-effect waves-light btn red" id="delete">DELETE ACCOUNT</a>
              </div>
