      ...
      <div class="row">
        <div class="col s12 m12">
          <div class="card z-depth-2">
             <div id="l1" class="login center-align <?php echo $color; ?> white-text">
               <?php
            ...
            <div class="card-content">
              ...
              <div class="row">
                ...
                <?php
                  ...
                  if($null) {
                    echo "<p>No papers found in this topic, come back later!</p>";
                  } else {
                    echo "<div class='row' style='text-align: center;'><strong><p>Read the original paper:
                    <a target='_blank' href='".$row['link']."'>Link</a></p></strong></div>";
                    echo "<div class='row' style='text-align: justify; margin-left: 2%; margin-right: 2%;'><p>".file_get_contents($file_location)."</p></div>";
                    echo '
