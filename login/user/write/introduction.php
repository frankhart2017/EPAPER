      ...
      <div class="row">
        <div class="col s12">
          <div class="card z-depth-2">
             <div id="l1" class="login center-align <?php echo $color; ?> white-text">INTRODUCTION</div>
            <div class="card-content">
                <div class="row mindset" style="margin-left: 2%;">
                  <?php

                    $sql = "SELECT * FROM `write` WHERE `topic` = 'introduction'";
                    $counter = 1;
                    $data = "";
                  ...
                  function download(filename, text) {
                    ...
                    $(document).ready(function(){
                      ...
                      for(var i =1;i<=12;i++){
                        ...
                        download("Introduction.txt",data);
