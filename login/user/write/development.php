      ...
      <div class="row">
        <div class="col s12">
          <div class="card z-depth-2">
             <div id="l1" class="login center-align <?php echo $color; ?> white-text">DEVELOPMENT</div>
            <div class="card-content">
                <div class="row mindset" style="margin-left: 2%;">
                  <?php

                    $sql = "SELECT * FROM `write` WHERE `topic` = 'development'";
                    $counter = 1;
                    $data = "";
